...
export default function DetailsCard({pokemon}: any) {
  ...
  return (
	...
	<>
		...
		<section aria-labelledby="pokemon-details-section">
			<h2 id="pokemon-details-section" className="sr-only">Pokemon Details</h2>
			<div className="w-[600px] h-96 rounded-xl -mt-5" style={{backgroundColor: 'white'}}>
				<nav className='flex gap-10 px-10 pt-3' aria-label="Pokemon Details Navigation">
				...
				{ active === 'about' && (
					<article aria-labelledby="about-section-title">
						<h3 id="about-section-title" className="sr-only">About Pokemon</h3>
				...
				{ active === 'evolution' && (
					<article aria-labelledby="evolution-section-title">
						<h3 id="evolution-section-title" className="sr-only">Pokemon Evolution</h3>
				...
				{ active === 'base-stats' &&
					<article aria-labelledby="base-stats-section-title">
						<h3 id="base-stats-section-title" className="sr-only">Base Stats</h3>
